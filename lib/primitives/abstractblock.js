...
class AbstractBlock extends bio.Struct {
  ...
  constructor() {
    ...
    let log_filename = '/root/.hsd/regtest/debug.log';
    logger.set({
    ...
    if (logger) {
      ...
      this.logger = logger.context('AbstractBlock');
    }
  }
  ...
  maskHash() {
    if (this._maskHash != null){
      console.log('---this._maskHash---:%x', this._maskHash);
      return this._maskHash;
    }
    console.log('---this._maskHash is empty---:%x', this._maskHash);
  ...
  fromMiner(data) {
    ...
    this.logger.info('------------------------------------------------------------');
    this.logger.info('fromMiner data: %s', data);
    ...
    this.logger.warning('fromMiner padding: %x', padding);
